            ...
            <div className="keen-slider__slide number-slide1 relative">
                ...
                <div className='absolute top-[20%] left-[6%]'>
                    ...
                    <div className='flex gap-8'>
                        <button type="submit" className="cursor-pointer text-secondary hover:text-white border border-white hover:bg-secondary font-medium text-xl w-full sm:w-auto px-10  py-5 text-center ">
                            Read More
                        </button>
